...
const changeTypeConfig: Record<string, { label: string; color: string; bg: string; icon: string }> = {
  purchased: { label: 'Hours Added', color: 'text-green-400', bg: 'bg-green-500/10', icon: '+' },
  used: { label: 'Hours Used', color: 'text-red-400', bg: 'bg-red-500/10', icon: '-' },
  adjustment: { label: 'Adjustment', color: 'text-blue-400', bg: 'bg-blue-500/10', icon: '±' },
}
...
export default function HoursPage() {
    ...
    return (
      <div className="flex items-center justify-center py-24">
        <div className="flex flex-col items-center gap-4">
          ...
          <p className="text-sm text-gray-400">Loading your hours...</p>
        </div>
      </div>
    )
  }
    ...
    return (
      ...
      >
        <div className="rounded-2xl bg-gray-900 p-8 text-center ring-1 ring-gray-800">
          ...
          <p className="mb-6 text-gray-400">Sign in to view your hours balance and activity.</p>
          <Link
            href="/portal/login"
    ...
    return (
      ...
      >
        <motion.div variants={itemVariants}>
          <h1 className="text-2xl font-semibold tracking-tight text-white">Hours Balance</h1>
          <p className="mt-1 text-gray-400">Track your time and materials usage.</p>
        </motion.div>
        <motion.div variants={itemVariants} className="rounded-2xl bg-gradient-to-br from-[#D2A62C]/10 to-[#D2A62C]/5 p-8 ring-1 ring-[#D2A62C]/20">
          <div className="mx-auto max-w-xl text-center">
            ...
            <h2 className="text-xl font-semibold tracking-tight text-white">No Hours Package Yet</h2>
  ...
  if (error) {
    return (
      ...
      >
        <h2 className="mb-2 text-xl font-semibold tracking-tight text-white">Unable to load hours</h2>
  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="grid gap-4 sm:grid-cols-3">
        <div className="rounded-2xl bg-gray-900 p-6 ring-1 ring-gray-800 transition-transform hover:translate-y-[-4px]">
          ...
          <div className="mt-4">
            ...
            <div className="text-sm text-gray-400">Hours Purchased</div>
          </div>
        </div>
        ...
        <div className="rounded-2xl bg-gray-900 p-6 ring-1 ring-gray-800 transition-transform hover:translate-y-[-4px]">
          ...
          <div className="mt-4">
            <div className={`text-3xl font-bold ${remainingHours <= 5 ? 'text-red-400' : 'text-white'}`}>
      ...
      {balance && balance.purchased_hours > 0 && (
        <motion.div variants={itemVariants} className="rounded-2xl bg-gray-900 p-6 ring-1 ring-gray-800">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="font-semibold tracking-tight text-white">Usage Progress</h3>
          ...
          <div className="mt-4 flex flex-wrap gap-4 text-sm">
            {balance.hourly_rate && (
              <div className="flex items-center gap-2">
                ...
                <span className="font-semibold text-white">${balance.hourly_rate}</span>
              </div>
            )}
            {balance.notes && (
              <div className="flex items-center gap-2">
                <span className="text-gray-400">Package:</span>
                <span className="font-medium text-gray-300">{balance.notes}</span>
              </div>
            )}
          </div>
        </motion.div>
      ...
      {remainingHours > 0 && remainingHours <= 10 && (
        <motion.div variants={itemVariants} className="rounded-2xl border border-yellow-500/20 bg-yellow-500/10 p-6">
          <div className="flex gap-4">
            ...
            <div>
              <h3 className="font-semibold tracking-tight text-yellow-200">Low Hours Balance</h3>
              ...
              <a
                ...
                className="mt-3 inline-flex items-center rounded-full bg-yellow-500/20 px-4 py-2 text-sm font-medium text-yellow-200 transition hover:bg-yellow-500/30"
              >
                Purchase More Hours
              </a>
            </div>
      ...
      {/* Activity Log */}
      <motion.div variants={itemVariants}>
        <h2 className="mb-4 text-lg font-semibold tracking-tight text-white">Activity Log</h2>
        {log.length === 0 ? (
          <div className="rounded-2xl border-2 border-dashed border-gray-800 bg-gray-900/50 p-12 text-center">
            ...
            <h3 className="text-lg font-semibold tracking-tight text-white">No activity yet</h3>
            <p className="mt-1 text-gray-400">Your hours activity will appear here.</p>
          </div>
        ) : (
            ...
            {log.map((entry, index) => {
              ...
              return (
                <motion.div
                  ...
                  className="flex items-center gap-4 rounded-2xl bg-gray-900 p-4 ring-1 ring-gray-800 transition-transform hover:translate-y-[-2px]"
                >
      ...
      <motion.div variants={itemVariants} className="rounded-2xl bg-gradient-to-r from-gray-800 to-gray-900 p-6 ring-1 ring-gray-700">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          <div>
            <h3 className="font-semibold tracking-tight text-white">Need more hours?</h3>
